...
import { setExportActivityOpen, setMenuOpen } from '../../store/slices/displaySlice';
import { downloadActivityGpx } from '../../controllers/ImportExportController';
...
function ExportActivityDialog() {
  ...
  const handleCancel = useCallback(() => {
    dispatch(setExportActivityOpen(false));
